...
const ProductDetiails = () => {
    ...
    const Star = '/icons/ProductDetails/rate.png';
    const unStar = '/icons/ProductDetails/unStar.png';
    const shop = '/icons/ProductDetails/shop.png';
    const warranty = '/icons/ProductDetails/warranty.png';
    const payment = '/icons/ProductDetails/payment.png';
    const love = '/icons/ProductDetails/love.png';
    const compare = '/icons/ProductDetails/compare.png';
    const upload = '/icons/ProductDetails/upload.png';
    ...
    const handleAddToCart = () => {
        const cartItem = {
            ...
            image: data.src, // assuming it's an array
                ...
                <div className='flex flex-col gap-3 '>
                    ...
                    <div className='flex gap-2'>
                        ...
                        <div
                            ...
                            className='bg-[#16A34A] text-white flex gap-1 items-center w-fit px-8 py-3 rounded-lg cursor-pointer'
                        >
                            <Image
                                src={shop}
                                alt="shop"
